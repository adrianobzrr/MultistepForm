    ...
    <div className="review-form">
        <div className="form-control score-container">
          <label className="radio-container">
            <input type="radio" value="unstisfied" name="review" required/>
        ...
        <div className="form-control">
          ...
          <textarea name="comment" id="comment" placeholder="Comte como foi a sua experiência com o produto..." required></textarea>
        </div>
    </div>
  )
}
